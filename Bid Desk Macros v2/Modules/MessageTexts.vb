Module MessageTexts
    ...
    Public Const dellDecline As String = "<br>&nbsp; Please note that a declined Dell DR can always be appealed if you feel you have a strong reason as to why it should have been approved - please contact hannah.frangiamore@insight.com and Stuart.Hyde@insight.com for help in making your case.<br>"
